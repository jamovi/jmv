...
corrPartOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "corrPartOptions",
...
corrPartResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
corrPartBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "corrPartBase",
